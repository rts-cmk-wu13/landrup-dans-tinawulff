    ...
    <section className="flex flex-col h-[100vh] justify-between z-full max-w-full">
        ...
        <Link href="/login" className=" flex justify-center bg-[#E9E9E9] text-[#003147] text-lg items-center p-4 rounded-lg z-10 h-[53px] w-full max-w-[300px] self-center shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] leading-none relative align-end">Log ind her</Link>
